...
if ( location.protocol.substr(0,4)  === 'file' ||
	...
	$.ajax({
		...
		$( document ).on( "mobileinit", function() {
			...
			.append( "<p style='margin:0; font-size:.9em; color:#fff;'>The AJAX-based navigation used throughout the app may need to be viewed on a web server to work in certain browsers.</p>" );
